...
word_replace = ["o1e", "t2o", "t3e", "4", "5e", "6", "7n", "8t", "9e"]
...
for line in sys.stdin:
    ...
    for idx, word_number in enumerate(word_numbers):
        print(f"    {word_number}: {idx+1}")

        line = re.sub(re.escape(word_number), word_replace[idx], line.rstrip())
